...
const SET_ASYNC = promisify(redisClient.SET).bind(redisClient);  // Promisifing Set Function 
const GET_ASYNC = promisify(redisClient.GET).bind(redisClient);    //  Promisifing Get Function 
